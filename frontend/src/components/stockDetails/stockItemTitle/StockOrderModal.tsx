      ...
      <div className="h-full flex flex-col items-center justify-between">
        ...
        <div className="w-full">
          ...
          <div className="flex flex-col gap-1">
            {/* 주문단가 */}
            <OrderDetails label="주문단가" value={currentPrice} />
            {/* 총 주문 금액 */}
            <OrderDetails label="총 주문금액" value={totalOrderAmount} />
          </div>
        </div>
...
const OrderDetails: React.FC<IorderDetails> = ({ label, value }) => {
  return (
    <div className="flex justify-between">
      <p className="text-sm text-neutral-500 font-bold">{label}</p>
